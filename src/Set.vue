<template>
  <div class="kaishuan">
    ...
    <mt-cell title="修改信息" to="/resetnews" is-link>
      <img slot="icon" src="../../../argument/开关栓项目/kaishuan1.0/static/images/kai/mainPage/resetnews.png" class="img_bolt">
    </mt-cell>
    <mt-cell title="密码修改" to="/resetpassword" is-link>
      <img slot="icon" src="../../../argument/开关栓项目/kaishuan1.0/static/images/kai/mainPage/resetpassword.png" class="img_bolt">
    </mt-cell>
    <mt-cell style="padding-right:0.2rem" v-show="!versions" title="系统升级" >
      <span class="system_text">当前版本{{oldVersions}}</span>
      <img slot="icon" src="../../../argument/开关栓项目/kaishuan1.0/static/images/kai/settingPage/upgrade_system.png" class="img_bolt">
    </mt-cell>
